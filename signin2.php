...
<body>
    <div class="container">
        <form action="" method="POST">
            ...
            <input type="text" name="p" id="prix" placeholder="Prix..."><br>
            <label>Domaine</label>
            <select name="d">
                <option value="">--</option>
                <option value="Dentiste">Dentiste</option>
                <option value="Psychologue">Psychologue</option>
                <option value="Médécin Généraliste">Médécin Généraliste</option>
     ...
     if($_POST['pass']==$_POST['pass1'])
        {
            ...
            {
                $requete = $db->prepare("INSERT INTO `m` (`nom`, `pass`,`email` ,`num`,`adress`,`domaine`,`prix`) VALUES (:c, :nu,:e,:n,:a,:d,:p)");
                $requete->execute(array(
                    'c' => $_POST["nom"], 'nu' => $_POST["pass"],'e'=>$_POST['email'],'n'=>$_POST['tel'],'a'=>$_POST['add'], 'd'=>$_POST['d'],'p'=>$_POST['p']
