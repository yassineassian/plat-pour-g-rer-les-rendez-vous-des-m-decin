            ...
            <a href=<?php  session_start();    if(isset($_SESSION['id']))
{
    echo 'categories.php';
                    ...
                    <div class="pbarre"></div>Trouver un rendez-vous avec
                </button></a>
    ...
    <section class="section1" id="apropos">
        ...
        <div class="secontainer">
            <div class="box">
                ...
                <h2>Médecin qualifiés</h2>
                <p> Les meilleurs médicin dans touts les domaines </p>
            </div>
            <div class="box">
            ...
            <div class="box">
                ...
                <p>la reponse des médecin en mois de 24h</p>
            </div>
...
if(!empty($_SESSION['offre']))
{
    ...
    Félicitations,votre rendez-vous vient d étre envoyée a '.$_SESSION['nomo'].'
</div>';
echo '<script>
